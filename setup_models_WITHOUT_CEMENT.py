...
displacement = -1.0
#input_directory = 'D:\Vertebroplasty Set\Abaqus_T2_CC1_T2_CC2_T6_CC1_T4_CC3/'
#output_directory = 'D:\Vertebroplasty Set\Abaqus_T2_CC1_T2_CC2_T6_CC1_T4_CC3/'
#load_point_csv_path = 'D:\Vertebroplasty Set\Abaqus_T2_CC1_T2_CC2_T6_CC1_T4_CC3/loadPosition.csv'
...
def meshTies(modelName):
    ...
    for current_entry in surfaces:
        ...
        # if current_entry.endswith("SF_VERTEBRAE_WITH_CEMENT"):
           # cementslave_entry = current_entry
        # if current_entry.endswith("SF_CEMENT_WITH_VERTEBRAE"):
           # cementmaster_entry = current_entry
    ...
    # cementmaster = mdb.models[modelName].rootAssembly.surfaces[cementmaster_entry]
    # cementslave = mdb.models[modelName].rootAssembly.surfaces[cementslave_entry]
    ...
    # mdb.models[modelName].Tie(name='cement_tie', master=cementmaster, slave=cementslave, positionToleranceMethod=COMPUTED, adjust=ON, tieRotations=ON, thickness=ON)
